...
HD_PWD='C:/Development/designing_with_vhdl/02_using_concurrent_statements/concurrency.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_manager_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_manager_tb.tcl
